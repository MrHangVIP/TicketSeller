...
public class ClusterManager<T extends ClusterItem> implements
    ...
    //        mRenderer.setMarkerView(view);
    //    }
    public void setMarkerViewListener(DefaultClusterRenderer.IMarkerViewListener markerViewListener){
      ((DefaultClusterRenderer)mRenderer).setMarkerViewListener(markerViewListener);
    }
