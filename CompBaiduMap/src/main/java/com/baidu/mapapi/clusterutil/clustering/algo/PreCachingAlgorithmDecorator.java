...
public class PreCachingAlgorithmDecorator<T extends ClusterItem> implements Algorithm<T> {
    ...
    // TODO: evaluate maxSize parameter for LruCacheForBaidu.
    private final LruCacheForBaidu<Integer, Set<? extends Cluster<T>>> mCache =
            new LruCacheForBaidu<Integer, Set<? extends Cluster<T>>>(5);
