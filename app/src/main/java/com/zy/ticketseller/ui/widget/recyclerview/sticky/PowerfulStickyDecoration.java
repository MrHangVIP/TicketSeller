...
import com.zy.ticketseller.ui.widget.recyclerview.sticky.listener.PowerGroupListener;
...
public class PowerfulStickyDecoration extends BaseDecoration {
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder setCardDivideHeight(int height) {
            mDecoration.mCardDivideHeight = height;
            return this;
        }
