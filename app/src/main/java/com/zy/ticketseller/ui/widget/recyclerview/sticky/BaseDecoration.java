package com.zy.ticketseller.ui.widget.recyclerview.sticky;
...
abstract class BaseDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        } else if(mCardDivideHeight != 0 && isLastInGroup(pos)){
            outRect.bottom = mCardDivideHeight;
        } else{
    ...
    private boolean isLastInGroup(int pos) {
        if (pos == 0) {
            ...
            String groupId = getGroupName(pos);
            String nextGroupId = getGroupName(pos + 1);
            return !TextUtils.equals(groupId, nextGroupId);
        }
    }
