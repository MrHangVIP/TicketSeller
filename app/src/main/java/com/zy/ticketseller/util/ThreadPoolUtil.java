...
/**
 * 线程池工具类
 * 4种线程池具体区别请看http://blog.csdn.net/ns_code/article/details/17465497
 *
 * @author zhanglei
 */
public final class ThreadPoolUtil {
    ...
    private static int default_delay = 500;//循环执行的默认初始化时间，第一次执行的初始化时间


//    /**
//     * 创建一个单线程化的线程池，它只会用唯一的工作线程来执行任务，保证所有任务按照指定顺序(FIFO, LIFO, 优先级)执行，尽量少使用
//     *
//     * @param command
//     */
//    public static Future<String> executeSingleThread(final Runnable command) {
...
//     * @param command 执行线程
//     */
//    public static Future<String> executeFixedThread(final Runnable command) {
//        if (null == fixedThreadPool) {
//            fixedThreadPool = Executors.newFixedThreadPool(SystemUtils.DEFAULT_THREAD_POOL_SIZE);
//        }
//        Callable<String> callable = new Callable<String>() {
//            @Override
//            public String call() throws Exception {
